...
public class DevDimTranspRightClickedInAirProcedure extends ThesufferingModElements.ModElement {
	public DevDimTranspRightClickedInAirProcedure(ThesufferingModElements instance) {
		super(instance, 24);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ThesufferingMod.LOGGER.warn("Failed to load dependency entity for procedure DevDimTranspRightClickedInAir!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		{
			...
			if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
				DimensionType destinationType = OrdoniaDimension.type;
