...
package net.mcreator.thesuffering.gui;
...
import net.mcreator.thesuffering.procedures.SynthesizerGUIWhileThisGUIIsOpenTickProcedure;
...
public class SynthesizerGUIGui extends ThesufferingModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public SynthesizerGUIGui(ThesufferingModElements instance) {
		super(instance, 11);
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			double z = entity.getPosZ();
			{
				...
				SynthesizerGUIWhileThisGUIIsOpenTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("synthesizer_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 52, 80) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 88, 80) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ThesufferingMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("thesuffering:textures/synthesizer_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Material Synthesis Chamber", 6, 7, -12829636);
		}
