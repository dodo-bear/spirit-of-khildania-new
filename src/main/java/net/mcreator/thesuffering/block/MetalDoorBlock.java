...
public class MetalDoorBlock extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:metal_door")
	public static final Block block = null;
	public MetalDoorBlock(ThesufferingModElements instance) {
		super(instance, 9);
	}
