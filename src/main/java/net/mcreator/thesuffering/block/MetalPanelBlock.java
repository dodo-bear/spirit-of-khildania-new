...
public class MetalPanelBlock extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:metal_panel")
	public static final Block block = null;
	public MetalPanelBlock(ThesufferingModElements instance) {
		super(instance, 6);
	}
