...
public class CompactedDryTurfBlock extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:compacted_dry_turf")
	public static final Block block = null;
	public CompactedDryTurfBlock(ThesufferingModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compacted_dry_turf");
		}
