...
public class BasicCryopodBlock extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:basic_cryopod")
	public static final Block block = null;
	public BasicCryopodBlock(ThesufferingModElements instance) {
		super(instance, 13);
	}
