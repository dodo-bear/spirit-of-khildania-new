...
public class CoreDrillerBlock extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:core_driller")
	public static final Block block = null;
	@ObjectHolder("thesuffering:core_driller")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CoreDrillerBlock(ThesufferingModElements instance) {
		super(instance, 31);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("core_driller"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("core_driller");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("core_driller");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Core Drill");
		}
