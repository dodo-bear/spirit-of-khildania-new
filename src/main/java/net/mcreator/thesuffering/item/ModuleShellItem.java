...
public class ModuleShellItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:module_shell")
	public static final Item block = null;
	public ModuleShellItem(ThesufferingModElements instance) {
		super(instance, 10);
	}
