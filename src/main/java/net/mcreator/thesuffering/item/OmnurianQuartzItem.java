...
public class OmnurianQuartzItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:ordonian_quartz")
	public static final Item block = null;
	public OmnurianQuartzItem(ThesufferingModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ordonian_quartz");
		}
