...
public class GelatinItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:gelatin")
	public static final Item block = null;
	public GelatinItem(ThesufferingModElements instance) {
		super(instance, 34);
	}
