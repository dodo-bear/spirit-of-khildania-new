...
public class LapizChunkItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:lapiz_chunk")
	public static final Item block = null;
	public LapizChunkItem(ThesufferingModElements instance) {
		super(instance, 35);
	}
