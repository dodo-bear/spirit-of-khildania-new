...
public class CapsuleCaseItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:capsule_case")
	public static final Item block = null;
	public CapsuleCaseItem(ThesufferingModElements instance) {
		super(instance, 44);
	}
