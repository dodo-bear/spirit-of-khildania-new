...
public class VoltBurstRifleItem extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:volt_burst_rifle")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletvolt_burst_rifle").setRegistryName("entitybulletvolt_burst_rifle");
	public VoltBurstRifleItem(ThesufferingModElements instance) {
		super(instance, 26);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(TheSufferingItemGroup.tab).maxDamage(1561));
			setRegistryName("volt_burst_rifle");
		}
