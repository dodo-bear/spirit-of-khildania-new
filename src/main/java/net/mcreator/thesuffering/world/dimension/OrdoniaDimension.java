...
package net.mcreator.thesuffering.world.dimension;
...
import net.mcreator.thesuffering.block.CompactedDryTurfBlock;
...
public class OrdoniaDimension extends ThesufferingModElements.ModElement {
	@ObjectHolder("thesuffering:ordonia")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public OrdoniaDimension(ThesufferingModElements instance) {
		super(instance, 18);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("ordonia"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("thesuffering:ordonia")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("thesuffering:ordonia"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("thesuffering:ordonia"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("thesuffering:ordonian_wastes")),};
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return CompactedDryTurfBlock.block.getDefaultState();
				}
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(CompactedDryTurfBlock.block.getDefaultState().getBlock(),
