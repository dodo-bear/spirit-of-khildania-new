...
package net.mcreator.thesuffering.world.structure;
...
public class OrdonianHouseStructure extends ThesufferingModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 10000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("thesuffering", "house"));
					if (template == null)
						return false;
	...
	public OrdonianHouseStructure(ThesufferingModElements instance) {
		super(instance, 23);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("ordonian_house"));
	}
